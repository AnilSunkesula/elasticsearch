...
HOSTNAME=`hostname`
DATA_PATH="/datadisc1/elasticsearch"
DATA_PATH_DEFAULT="/var/lib/elasticsearch"
mv /var/lib/elasticsearch /datadisc1
...
sudo sed -i "s/path.data: \/var\/lib\/elasticsearch/path.data: \/datadisc1\/elasticsearch/g" /etc/elasticsearch/elasticsearch.yml
